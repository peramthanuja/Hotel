...
<nav id="nav-bar" class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand me-5 fm-bold fs-3 h-font" href="index.php">HAPPY STAY</a>
            ...
            <form id="login-form">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        <button type="submit" class="btn text-secondary text-decoration-none shadow-none p-0" data-bs-toggle="modal" data-bs-target="#forgotModal" data-bs-dismiss="modal">
                            Forgot password
                        </button>
                    </div>
                </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-12 p-0 mb-3">
                                ...
                                <textarea name="address" type="text" class="form-control shadow-none" rows="1" ></textarea>
                            </div>
                            <div class="col-md-6 ps-0 mb-3">
